...
Participants arrive and are welcomed at the door. |Facilitator A stands near the entrance with the name labels. Facilitator B sets out the prompt cards and the stone on the central table.| A small bowl of pebbles by the door doubles as a tally — one in the bowl per person seated.
...
I'll be keeping a soft eye on the time so you don't have to. |Holds up the small stone.| And this is the talking stone — it's how we'll know whose turn it is.
