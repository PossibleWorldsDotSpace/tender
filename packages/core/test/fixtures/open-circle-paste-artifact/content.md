...
Open Circle is a partici­patory workshop format for groups of 15–20 people. Over three hours, participants share short stories from their neighbourhood, listen atten​tively to each other, and weave threads from one telling into the next — building a portrait of a place that no single voice could draw alone.
