...
:::row{label="Approx 30 minutes" icon=clock no-break=true}
...
:::row{label="90 minutes" icon=clock no-break=true}
...
:::row{label="30 minutes" icon=clock no-break=true}
...
:::row{label="The Prompt Cards" icon=check no-break=true}
...
:::row{label="The Talking Stone" icon=check no-break=true}
...
:::row{label="Furniture & Room Setup" icon=check no-break=true}
